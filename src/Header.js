...
import "./Header.css";
import IMG1 from "./Assets/channel_profile_logo.jpg";
import LOGO_IMG from "./img/logo.PNG";
import SEARCH_IMG from "./img/search.PNG";
import VIDEO_IMG from "./img/video.PNG";
import GRID_IMG from "./img/grid.PNG";
import BELL_IMG from "./img/bell.PNG";
...
function Header() {
  return (
    ...
    //         <a
    //           href="https://www.youtube.com/@Ameen_Works"
    //           rel="noreferrer"
    //           target="_blank"
    //         >
    //           <img src={IMG1} alt="My_Channel" className="dp mxy-15" />
    //         </a>
    //       </div>
    //     </div>
    //   </div>
    ...
    <nav class="navbar">
      ...
      <div class="user-options">
        <img src={VIDEO_IMG} class="icon" alt="" />
        <img src={GRID_IMG} class="icon" alt="" />
        <img src={BELL_IMG} class="icon" alt="" />
        <div class="user-dp">
          <img src={IMG1} alt="My_Channel" />
        </div>
      </div>
    </nav>
  );
