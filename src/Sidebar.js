...
import EXPLORE_IMG from "./img/explore.PNG";
import SUBSCRIPTION_IMG from "./img/subscription.PNG";
import LIBRARY_IMG from "./img/library.PNG";
import HISTORY_IMG from "./img/history.PNG";
import YOUR_VIDEO_IMG from "./img/your-video.PNG";
import WATCH_LATER_IMG from "./img/watch-later.PNG";
import LIKED_VIDEOS_IMG from "./img/liked video.PNG";
import SHOW_MORE_IMG from "./img/show more.PNG";
...
function Sidebar() {
  return (
    <div class="side-bar">
      ...
      <a href="#" class="links">
        <img src={YOUR_VIDEO_IMG} alt="" />
        your video
      </a>
      <a href="#" class="links">
        <img src={WATCH_LATER_IMG} alt="" />
        watch leater
      </a>
      <a href="#" class="links">
        <img src={LIKED_VIDEOS_IMG} alt="" />
        like video
      </a>
      <a href="#" class="links">
        <img src={SHOW_MORE_IMG} alt="" />
        show more
      </a>
    </div>
